...
6. **Configure MoMo payment** (optional)
   ...
   {
    "partnerCode": "MOMO",
    "orderId": "MOMO-3025-1755869233997",
    "requestId": "REQ-3025",
    "amount": 135000,
    "orderInfo": "Test IPN",
    ...
    "message": "Success",
    "payType": "qr",
    "responseTime": 1724300000000,
    "extraData": "<BASE64_của_orderId=3023>",
    "signature": "test"
   }
   ```
...
1. **Prerequisites**
   ...
   - Thunder Client (VS Code Extension) or Postman: To send the POST request.

2. **Step-by-Step Guide**
   - Open your terminal and run the following command to expose port 7019: ngrok http https://localhost:7019/
   - Note: Copy the forwarding URL generated by Ngrok (e.g., https://2f85ed6bcc94.ngrok-free.app).
...
### Development Team
- **Lương Bảo Huy** - *Full Stack Developer* - [GitHub](https://github.com/LuongBaoHuy)

## 🎓 Academic Information

**Project Type**: Basic Project
**Institution**: NamCanThoUniversity
